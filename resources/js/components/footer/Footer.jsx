...
function Footer() {
  return (
    <footer className="text-center mt-20 lg:text-left bg-gray-100 text-gray-600">
      <div className="content-center  items-center lg:justify-between p-6 border-b border-gray-300">
      ...
      <div className="mx-40 py-10 text-center md:text-left content-center">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8  ">
          ...
          "
            >
              <img src="/images/manit.jpg" alt="LOGO" className="pr-3"></img>
              MAJOR PROJECT
            </h6>
            <p>
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a href="/clubs" className="text-gray-600">
                Clubs
              </a>
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              <a href="/tournaments" className="text-gray-600">
                Tournaments
              </a>
            </p>
            <p>
